...
public class ApiURL {
    ...
    public static final String URL_DATA = "history/api/v1/data/";
    ...
    public static final String URL_SAVE_LOG = "/history/api/v1/add/log/";
    public static final String URL_SAVE_INFO = "/history/api/v1/add/info/";
